...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("P2P-labp2");
...
int main(int argc, char * argv[])
{
	...
	Address localadd1(InetSocketAddress(Ipv4Address::GetAny()));
	PacketSinkHelper psh1(socketType,localadd1);
	ApplicationContainer sinkapps1=psh1.Install(nodes.Get(2));
	...
	p2p1.EnableAsciiAll(ascii.CreateFileStream("P2p1tracefile.tr"));
